...
void ndWindowModule::onBeginStartUp(ndEvent* event) {
    ...
    vertices[0].position = { -0.5f, -0.5f,  0.0f, 1.5f };
    vertices[1].position = {  0.5f, -0.5f, -1.0f, 1.5f };
    vertices[2].position = {  0.5f,  0.5f, -1.0f, 1.5f };

    vertices[3].position = {  0.5f,  0.5f, -1.0f, 1.5f };
    vertices[4].position = { -0.5f,  0.5f,  0.0f, 1.5f };
    vertices[5].position = { -0.5f, -0.5f,  0.0f, 1.5f };

    vertices[0].color = { 0.4f, 0.4f, 0.4f, 1.0f };
    vertices[1].color = { 0.4f, 0.4f, 0.4f, 1.0f };
    vertices[2].color = { 0.4f, 0.4f, 0.4f, 1.0f };

    vertices[3].color = { 0.4f, 0.4f, 0.4f, 1.0f };
    vertices[4].color = { 0.4f, 0.4f, 0.4f, 1.0f };
    vertices[5].color = { 0.4f, 0.4f, 0.4f, 1.0f };
